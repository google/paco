...
public interface CSExperimentIdVersionDao {
  ...
  boolean updateExperimentIdGroupNameStatus(Long expId, Integer expVersion, String groupName, Integer status) throws SQLException;
}
