 ...
 *
 */
public class ExperimentDetailPanel extends Composite {
  ...
  public ExperimentDetailPanel() {
    super();
  }


  public ExperimentDetailPanel(ExperimentDAO experiment, LoginInfo loginInfo, ExperimentListener listener) {
