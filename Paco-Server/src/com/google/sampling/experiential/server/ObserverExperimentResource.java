...
/**
 * A resource for a specific observed experiment. According to the router, these
 * methods are accessible via /observer/experiments/{experimentId}.
 *
 * @author corycornelius@google.com (Cory Cornelius)
 */
public class ObserverExperimentResource extends PacoExperimentResource {
  /*
   * Ensure the logged-in user is an observer of the experiment they are trying
   * to access.
   *
   * (non-Javadoc)
  ...
  /**
   * Updated the observed experiment with the specified experiment. If the
   * versions numbers do not match an conflict is raised. Otherwise the update
   * is forced to be on the same experiment with the version number incremented.
   *
