...
import com.google.sampling.experiential.server.ExperimentAccessManager.DateCount;
 ...
 *
 */
public class ParticipantJoinStatServlet extends HttpServlet {

  public static final Logger log = Logger.getLogger(ParticipantJoinStatServlet.class.getName());
...
//      }
  ...
  private String readStats() {
    List<DateCount>[] stats = ExperimentAccessManager.getTotalJoinedParticipantsCountsByMonth();
    return jsonifyEvents(stats);
  }

  private String jsonifyEvents(Object report) {
