...
public class InvitationServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    if (!Strings.isNullOrEmpty(experimentIdParam) && !Strings.isNullOrEmpty(countParam)) {
      if (ExperimentAccessManager.isUserAdmin(new Long(experimentIdParam), email)) {
        ...
        List<Invitation> invitations = new InvitationGenerator().generateNInvitations(email,new Long(experimentIdParam), count, offset);
