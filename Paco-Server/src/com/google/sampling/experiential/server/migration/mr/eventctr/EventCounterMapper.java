...
public class EventCounterMapper extends Mapper<Entity, String, Integer> {

  private static final long serialVersionUID = -3070710020513042698L;

  public static final Logger log = Logger.getLogger(EventCounterMapper.class.getName());
