...
/**
 * A resource for a specific viewable experiment. According to the router, this
 * resource is available at /experiments/{experimentId}.
 *
...
public class ExperimentResource extends PacoExperimentResource {
  ...
  /**
   * Enrolls the current user into the experiment with an (optionally) specified
   * signal-schedule.
   *
