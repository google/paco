...
public enum QueryConstants {
  ...
  GET_ALL_EXPERIMENT_LITE_IN_EXPERIMENT_ID_VERSION("select * from experiment_id_version_group_name where status=? order by experiment_id, experiment_version desc, group_name" ),
