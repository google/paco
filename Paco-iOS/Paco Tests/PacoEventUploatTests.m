//
//  PacoEventUploatTests.m
//  Paco
//
//  Created by northropo on 11/1/15.
...
@implementation PacoEventUploatTests
...
- (void) testUpload{
    ...
    PacoEventExtended *event;
    PacoEventManagerExtended  * eventManager = [PacoEventManagerExtended new];
    
    
    
    
    
    [eventManager startUploadingEvents];
