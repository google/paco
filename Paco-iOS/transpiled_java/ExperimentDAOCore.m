...
id<JavaUtilList> PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS;
...
+ (void)initialize {
  if (self == [PAExperimentDAOCore class]) {
    PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS = new_JavaUtilArrayList_init();
    {
      [PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS addWithId:JavaLangInteger_valueOfWithInt_(PAExperimentDAOCore_APP_USAGE_BROWSER_HISTORY_DATA_COLLECTION)];
      [PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS addWithId:JavaLangInteger_valueOfWithInt_(PAExperimentDAOCore_LOCATION_DATA_COLLECTION)];
      [PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS addWithId:JavaLangInteger_valueOfWithInt_(PAExperimentDAOCore_PHONE_DETAILS)];
      [PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS addWithId:JavaLangInteger_valueOfWithInt_(PAExperimentDAOCore_APP_INSTALL_DATA_COLLECTION)];
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithJavaLangLong:withNSString:withNSString:withNSString:withNSString:withNSString:withJavaLangBoolean:withJavaLangBoolean:withJavaUtilList:withNSString:withNSString:withNSString:withJavaUtilDate:withJavaUtilDate:", "ExperimentDAOCore", NULL, 0x1, NULL, "(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Boolean;Ljava/lang/Boolean;Ljava/util/List<Ljava/lang/Integer;>;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V" },
    ...
    { "getExtraDataCollectionDeclarations", NULL, "Ljava.util.List;", 0x1, NULL, "()Ljava/util/List<Ljava/lang/Integer;>;" },
    { "setExtraDataCollectionDeclarationsWithJavaUtilList:", "setExtraDataCollectionDeclarations", "V", 0x1, NULL, "(Ljava/util/List<Ljava/lang/Integer;>;)V" },
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "APP_USAGE_BROWSER_HISTORY_DATA_COLLECTION", "APP_USAGE_BROWSER_HISTORY_DATA_COLLECTION", 0x19, "I", NULL, NULL, .constantValue.asInt = PAExperimentDAOCore_APP_USAGE_BROWSER_HISTORY_DATA_COLLECTION },
    { "LOCATION_DATA_COLLECTION", "LOCATION_DATA_COLLECTION", 0x19, "I", NULL, NULL, .constantValue.asInt = PAExperimentDAOCore_LOCATION_DATA_COLLECTION },
    { "PHONE_DETAILS", "PHONE_DETAILS", 0x19, "I", NULL, NULL, .constantValue.asInt = PAExperimentDAOCore_PHONE_DETAILS },
    { "APP_INSTALL_DATA_COLLECTION", "APP_INSTALL_DATA_COLLECTION", 0x19, "I", NULL, NULL, .constantValue.asInt = PAExperimentDAOCore_APP_INSTALL_DATA_COLLECTION },
    { "EXTRA_DATA_COLLECTION_DECLS", "EXTRA_DATA_COLLECTION_DECLS", 0x19, "Ljava.util.List;", &PAExperimentDAOCore_EXTRA_DATA_COLLECTION_DECLS, "Ljava/util/List<Ljava/lang/Integer;>;", .constantValue.asLong = 0 },
    { "title_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "description__", "description", 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "creator_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "organization_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "contactEmail_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "contactPhone_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "joinDate_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "id__", "id", 0x4, "Ljava.lang.Long;", NULL, NULL, .constantValue.asLong = 0 },
    { "informedConsentForm_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL, .constantValue.asLong = 0 },
    { "recordPhoneDetails_", NULL, 0x2, "Ljava.lang.Boolean;", NULL, NULL, .constantValue.asLong = 0 },
    { "extraDataCollectionDeclarations_", NULL, 0x2, "Ljava.util.List;", NULL, "Ljava/util/List<Ljava/lang/Integer;>;", .constantValue.asLong = 0 },
    { "deleted_", NULL, 0x4, "Ljava.lang.Boolean;", NULL, NULL, .constantValue.asLong = 0 },
    { "earliestStartDate_", NULL, 0x2, "Ljava.util.Date;", NULL, NULL, .constantValue.asLong = 0 },
    { "latestEndDate_", NULL, 0x2, "Ljava.util.Date;", NULL, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _PAExperimentDAOCore = { 2, "ExperimentDAOCore", "com.pacoapp.paco.shared.model2", NULL, 0x1, 31, methods, 19, fields, 0, NULL, 0, NULL, NULL, NULL };
...
void PAExperimentDAOCore_initWithJavaLangLong_withNSString_withNSString_withNSString_withNSString_withNSString_withJavaLangBoolean_withJavaLangBoolean_withJavaUtilList_withNSString_withNSString_withNSString_withJavaUtilDate_withJavaUtilDate_(PAExperimentDAOCore *self, JavaLangLong *id_, NSString *title, NSString *description_, NSString *informedConsentForm, NSString *creatorEmail, NSString *joinDate, JavaLangBoolean *recordPhoneDetails, JavaLangBoolean *deleted2, id<JavaUtilList> extraDataCollectionDeclarationsList, NSString *organization, NSString *contactPhone, NSString *contactEmail, JavaUtilDate *earliestStartDate, JavaUtilDate *latestEndDate) {
  ...
  self->recordPhoneDetails_ = JavaLangBoolean_valueOfWithBoolean_(false);
  self->deleted_ = JavaLangBoolean_valueOfWithBoolean_(false);
  self->id__ = id_;
  self->title_ = title;
  self->description__ = description_;
  self->informedConsentForm_ = informedConsentForm;
  ...
  self->deleted_ = JavaLangBoolean_valueOfWithBoolean_(self->deleted_ != nil ? [self->deleted_ booleanValue] : false);
...
PAExperimentDAOCore *create_PAExperimentDAOCore_initWithJavaLangLong_withNSString_withNSString_withNSString_withNSString_withNSString_withJavaLangBoolean_withJavaLangBoolean_withJavaUtilList_withNSString_withNSString_withNSString_withJavaUtilDate_withJavaUtilDate_(JavaLangLong *id_, NSString *title, NSString *description_, NSString *informedConsentForm, NSString *creatorEmail, NSString *joinDate, JavaLangBoolean *recordPhoneDetails, JavaLangBoolean *deleted2, id<JavaUtilList> extraDataCollectionDeclarationsList, NSString *organization, NSString *contactPhone, NSString *contactEmail, JavaUtilDate *earliestStartDate, JavaUtilDate *latestEndDate) {
  return new_PAExperimentDAOCore_initWithJavaLangLong_withNSString_withNSString_withNSString_withNSString_withNSString_withJavaLangBoolean_withJavaLangBoolean_withJavaUtilList_withNSString_withNSString_withNSString_withJavaUtilDate_withJavaUtilDate_(id_, title, description_, informedConsentForm, creatorEmail, joinDate, recordPhoneDetails, deleted2, extraDataCollectionDeclarationsList, organization, contactPhone, contactEmail, earliestStartDate, latestEndDate);
}
...
void PAExperimentDAOCore_init(PAExperimentDAOCore *self) {
  ...
  self->recordPhoneDetails_ = JavaLangBoolean_valueOfWithBoolean_(false);
  self->deleted_ = JavaLangBoolean_valueOfWithBoolean_(false);
  self->extraDataCollectionDeclarations_ = new_JavaUtilArrayList_init();
}
...
PAExperimentDAOCore *create_PAExperimentDAOCore_init() {
  return new_PAExperimentDAOCore_init();
}
