...
- (void)viewDidLoad {
  ...
  UILabel* creatorLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, descriptionLabel.frame.origin.y + descriptionLabel.frame.size.height + 20, self.view.frame.size.width - 20, 20)];
