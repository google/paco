...
IOSIntArray *PAPacoAction_ACTIONS_;
IOSObjectArray *PAPacoAction_ACTION_NAMES_;
...
+ (void)initialize {
  if (self == [PAPacoAction class]) {
    PAPacoAction_ACTIONS_ = [IOSIntArray newArrayWithInts:(jint[]){ PAPacoAction_NOTIFICATION_TO_PARTICIPATE_ACTION_CODE, PAPacoAction_NOTIFICATION_ACTION_CODE, PAPacoAction_LOG_EVENT_ACTION_CODE, PAPacoAction_EXECUTE_SCRIPT_ACTION_CODE } count:4];
    PAPacoAction_ACTION_NAMES_ = [IOSObjectArray newArrayWithObjects:(id[]){ @"Create notification to participate", @"Create notification message", @"Log data", @"Execute script" } count:4 type:NSString_class_()];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "NOTIFICATION_TO_PARTICIPATE_ACTION_CODE_", NULL, 0x19, "I", NULL, NULL, .constantValue.asInt = PAPacoAction_NOTIFICATION_TO_PARTICIPATE_ACTION_CODE },
    { "NOTIFICATION_ACTION_CODE_", NULL, 0x19, "I", NULL, NULL, .constantValue.asInt = PAPacoAction_NOTIFICATION_ACTION_CODE },
    { "LOG_EVENT_ACTION_CODE_", NULL, 0x19, "I", NULL, NULL, .constantValue.asInt = PAPacoAction_LOG_EVENT_ACTION_CODE },
    { "EXECUTE_SCRIPT_ACTION_CODE_", NULL, 0x19, "I", NULL, NULL, .constantValue.asInt = PAPacoAction_EXECUTE_SCRIPT_ACTION_CODE },
    { "ACTIONS_", NULL, 0x19, "[I", &PAPacoAction_ACTIONS_, NULL,  },
    { "ACTION_NAMES_", NULL, 0x19, "[Ljava.lang.String;", &PAPacoAction_ACTION_NAMES_, NULL,  },
    { "actionCode_", NULL, 0x2, "Ljava.lang.Integer;", NULL, NULL,  },
    { "id__", "id", 0x2, "Ljava.lang.Long;", NULL, NULL,  },
    { "type_", NULL, 0x4, "Ljava.lang.String;", NULL, NULL,  },
  };
