...
- (void)it_appendValue:(id)value forKey:(id)key {
  NSAssert([self[key] isKindOfClass:[NSMutableArray class]] || !self[key],
           @"Method may only be applied for values of NSMutableArray class");
...
- (void)setIt_defaultValue:(id)it_defaultValue {
  objc_setAssociatedObject(self, kITDefaultValueKey, it_defaultValue,
