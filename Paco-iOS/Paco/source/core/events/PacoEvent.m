...
+ (id)pacoEventFromJSON:(id)jsonObject {
    ...
    event.latitude = eventMembers[kPacoEventKeyLatitude];
    event.longitude = eventMembers[kPacoEventKeyLongitude];
    ...
    event.experimentVersion = eventMembers[kPacoEventKeyExperimentVersion];
...
- (id)generateJsonObject {
    ...
    dictionary[kPacoEventKeyExperimentVersion] = [NSString stringWithFormat:@"%d", [self.experimentVersion intValue]];
    ...
    if (self.latitude) {
        dictionary[kPacoEventKeyLatitude] = [NSString stringWithFormat:@"%lld", [self.latitude longLongValue]];
    }
    if (self.longitude) {
        dictionary[kPacoEventKeyLongitude] = [NSString stringWithFormat:@"%lld", [self.longitude longLongValue]];
    }
...
+ (PacoEvent*)joinEventForDefinition:(PacoExperimentDefinition*)definition
    ...
    event.experimentVersion = [NSNumber numberWithInt:definition.experimentVersion ];
...
+ (PacoEvent*)stopEventForExperiment:(PacoExperiment*)experiment
{
    ...
    event.experimentVersion = [NSNumber numberWithInt:experiment.definition.experimentVersion];
    event.responseTime = [NSDate dateWithTimeIntervalSinceNow:0];
