...
public class ExperimentUtil {
	/**
	 * 
	 * @param eventsOutputColumns This holds all the column names of the tables Events and Outputs as keys 
	 * and the associated table name as value
	 * @param colNames List of names that the client has asked for in the query
	 * @return Table name that should be used for the given columns. This will have the following three scenarios
	 ...
	 * 			- If all input columns are a mix of the Outputs and Events table or a '*', will return Eventsoutputs table 
	 */
	 ...
	 /**
	  * 
	  * @param inputString contains all the columns names and with some sql key words depending upon the user query 
	  * @return the list of column names
	  */
	 public static  List<String> aggregateExtractedColNames(String inputString){
	   //any non word character or the words 'and' 'or' 'is' 'not' get replaced with blank
