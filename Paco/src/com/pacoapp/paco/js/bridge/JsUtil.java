...
public class JsUtil {
	/**
	 * Method that takes in query parameters in a JSON format, and converts it into POJO of type SQLQuery
	 ...
	 *    query->select: String which holds the column names separated by commas
	 ...
	 * @param queryJson Query criteria and clauses in JSON format
	 * @return SQLQuery holds the extracted values from JSON input
