...
public class AccessibilityEventMonitorService extends AccessibilityService {
  ...
  public void onAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
    ...
    if (isPackageInstallerEvent(packageName)) {
      handleRuntimePermissionEvents(accessibilityEvent);
      return;
    } else {
  ...
  private boolean isPackageInstallerEvent(CharSequence packageName) {
  ...
  private void inspectEvent(AccessibilityEvent accessibilityEvent) {
    CharSequence packageName = accessibilityEvent.getPackageName();
    // Log.debug("Event received: " + accessibilityEvent.toString());
    ...
    case AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED:
      eventTypeDescription = "windowstatechange";
      break;
    case AccessibilityEvent.TYPE_ANNOUNCEMENT:
      eventTypeDescription = "announcement";
      break;
    case AccessibilityEvent.TYPE_VIEW_CLICKED:
      eventTypeDescription = "viewclicked";
      break;
    case AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED:
      eventTypeDescription = "notificationstate";
      break;
    default:
      // Log.debug("unknown accessibility event");
      break;

    }
    if (eventTypeDescription != null) {
      String msg = eventToString(packageName, className, contentDescription, eventTypeDescription);
      Log.info(msg);
    }
  }

  private String eventToString(CharSequence packageName, CharSequence className, CharSequence contentDescription,
                               String eventTypeDescription) {
    return String.format("EVENT: type: %s, p: %s, c: %s, cd: %s", eventTypeDescription, packageName, className,
                        contentDescription);
  }

  private void handleRuntimePermissionEvents(AccessibilityEvent accessibilityEvent) {
