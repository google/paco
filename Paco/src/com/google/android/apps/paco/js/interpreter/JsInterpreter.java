  ...
  public static class RestrictedContextFactory extends ContextFactory {
    private static final Set<String> ALLOWED_CLASS_NAMES =
              ImmutableSet.of("java.util.ArrayList",
                              ...
                              com.google.android.apps.paco.js.bridge.JavascriptEventLoader.class.getName(),
                              com.google.android.apps.paco.js.bridge.JavascriptExperimentLoader.class.getName()
                              );
    @Override
