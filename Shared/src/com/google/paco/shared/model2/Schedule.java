...
public class Schedule  implements Validatable, MinimumBufferable, Serializable {
     ...
     * @param snoozeTime
     */
    public Schedule(Integer scheduleType, Boolean byDayOfMonth,
        Integer dayOfMonth, Long esmEndHour, Integer esmFrequency, Integer esmPeriodInDays,
        Long esmStartHour, Integer nthOfMonth, Integer repeatRate, List<SignalTime> times,
        Integer weekDaysScheduled, Boolean esmWeekends, Integer timeout, Integer minimumBuffer, Integer snoozeCount,
        Integer snoozeTime) {
