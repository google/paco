...
public class ExperimentTest {
  ...
  public void testAddViewer() {
    ...
    assertTrue(experiment.addViewer("user"));
    assertNotNull(experiment.getViewers());
    assertTrue(experiment.hasViewer("user"));
  }
  ...
  public void testRemoveViewer() {
    ...
    assertFalse(experiment.removeViewer("user"));
  }

  @Test
  public void testRemoveViewerAfterAddViewer() {
    Experiment experiment = new Experiment();

    assertTrue(experiment.addViewer("user"));
    assertTrue(experiment.isPrivate());
    assertTrue(experiment.removeViewer("user"));
    assertFalse(experiment.isPrivate());
    assertTrue(experiment.hasViewer("user"));
  }
  ...
  public void testAddSubject() {
    ...
    assertTrue(experiment.addSubject("user"));
    assertTrue(experiment.hasSubject("user"));
  }
  ...
  public void testRemoveSubject() {
    ...
    assertFalse(experiment.removeSubject("user"));
  }

  @Test
  public void testRemoveSubjectAfterAddSubject() {
    Experiment experiment = new Experiment();

    assertTrue(experiment.addSubject("user"));
    assertTrue(experiment.removeSubject("user"));
    assertFalse(experiment.hasSubject("user"));
  }
  ...
  public void testAddObserver() {
    ...
    assertTrue(experiment.addObserver("user"));
    assertTrue(experiment.hasObserver("user"));
  }
  ...
  public void testRemoveObserver() {
    ...
    assertFalse(experiment.removeObserver("user"));
  }

  @Test
  public void testRemoveObserverAfterAddObserver() {
    Experiment experiment = new Experiment();

    assertTrue(experiment.addObserver("user"));
    assertTrue(experiment.removeObserver("user"));
    assertFalse(experiment.hasObserver("user"));
  }
}
